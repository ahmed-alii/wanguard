<?php include_once "includes/header.php" ?>
            ...
            <div class="position-relative">
                <div class="position-absolute cards-position w-100">
                    <div class="row mx-auto justify-content-center">
                        ...
                        <div class="col-10 col-md-6 col-lg-3 mb-5 mb-lg-0">
                            <div class="card card-wrapper" data-bs-toggle="modal"
                                 data-bs-target="#request-matchup-modal">
                                <div class="card-body card-content text-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         x="0px"
                        ...
                        <div class="col-10 col-md-6 col-lg-3 mb-5 mb-lg-0">
                            <div class="card card-wrapper" data-bs-toggle="modal" data-bs-target="#new-team-modal">
                                <div class="card-body card-content text-center">
                        ...
                        <div class="col-10 col-md-6 col-lg-3 mb-5 mb-lg-0">
                            <div class="card card-wrapper" data-bs-toggle="modal" data-bs-target="#new-family-modal">
                                <div class="card-body card-content text-center">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                         xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <!--request-matchup Modal -->
    <div class="modal fade" id="request-matchup-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
         aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!--new-team-modal -->
    <div class="modal fade" id="new-team-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
         aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!--new-family-modal -->
    <div class="modal fade" id="new-family-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
         aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
