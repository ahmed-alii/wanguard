...
$("#signup").submit(function (e) {
  e.preventDefault();
  var ajax_data = new FormData(); //append into ajax data
  ...
  $.ajax({
    ...
    success: function success(data) {
      if (data.trim() == "email-exist") {
        swal("Info", "This email is already exist, please login", "info").then(function (result) {
          window.location.href = "login";
        });
      } else if (data.trim() == "true") {
        swal("Success", "You are registered, we send you profile approve email soon", "success").then(function (value) {
...
$("#edit_profile").submit(function (e) {
  ...
  ajax_data.append('email', $('#edit_email').val()); // ajax_data.append('phone',$('#edit_phone').val());
  ...
  $.ajax({
    ...
    success: function success(data) {
      if (data.trim() == "true") {
        swal("Success", "Profile update successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#forget_password_email").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      if (data.trim() == "true") {
        swal("", "We’ve sent a recovery link to your email", "success").then(function (value) {
          window.location.href = "index";
        });
...
$("#recoverPassword").submit(function (event) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      if (data.trim() == "true") {
        swal("Updated Successfully", "Password updated successfully!", "success").then(function (value) {
          window.location.href = "login";
        });
...
$("#updatepasswordform").submit(function (event) {
  ...
  if (newpass != confirmpass) {
    swal("Password missmatch", "Your password and confirm password don't match", "info"); // $('#updatepasswordform').trigger("reset");
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Password update successfully!", "", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#add_event").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Event added successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#edit_event").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      if (data.trim() == "true") {
        swal("Success", "Event edit successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#add_team_member").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Team member added successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#edit_team_member").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Team member edit successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#edit_new_client").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "User edit successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#edit_bio").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Bio edit successfully ", "success").then(function (value) {
...
$("#new-appointment").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "New Appointment added successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#new-recruit").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "New Recruit added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#new-client1").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "New Client added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#add_guests").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "New Guest added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#welcome-setting-page").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Video file Upload Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#add_md").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "MD Added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#add_smd").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "SMD Added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#recruitment_tools").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Recruiting Tools Added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#section_form").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#client_tools").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Client Tools Added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#section_form_image").submit(function (e) {
  ...
  ajax_data.append('url', $('#url').val()); // ajax_data.append('images', $('#images').prop('files')[0]);
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Image Added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
  ...
  swal({
    ...
    if (result) {
      $.ajax({
        ...
        success: function success(data) {
          if (data.trim() == "true") {
            swal("Success", "Reset Successfully ", "success").then(function (value) {
              location.reload();
            });
          } else {
            swal({
...
$("#one_three").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "1 / 300 added successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#training_section_form_image").submit(function (e) {
  ...
  ajax_data.append('url', $('#training_url').val()); // ajax_data.append('images', $('#images').prop('files')[0]);
...
$("#Update_trainers_section_form").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      if (data.trim() == "true") {
        swal("Success", "Update successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#dashboard_btns").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Button Links Added Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
...
$("#dashboard_input").submit(function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.trim() == "true") {
        swal("Success", "Table Data Updated Successfully ", "success").then(function (value) {
          location.reload();
        });
      } else {
