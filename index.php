            ...
            <div class="row justify-content-center">
                <div class="col-md-8 my-5">
                    ...
                    <h4 class="text-white fw-light">Our mission is to build the largest financial services company
                        with 1,00,000 licensed agents, create 1,000 millionaires, and help 10 million families
                    ...
                    <div class="card-body table-container" style="overflow-y: auto;">
                        <div id="myTable">
                            ...
                            foreach ($events as $event) {
                                ?>
                                <a target="" class="text-decoration-none " href="<?= $event['event_link'] ?>"><p
                                            class="text-primary fw-bold p-0 m-0"><?= $event['name'] ?></p></a>
                                <p class="m-0 py-1 calender-location"><i
                                            class="fa fa-map-marker"></i> <?= $event['location'] ?></p>
                                <p class="m-0 py-1 calender-description"><?= $event['description'] ?></p>
                                <a class="m-0 py-1 text-decoration-none calender-description"
                                   href="<?= $event['event_link'] ?>"><?= $event['event_link'] ?></a>
                                <p class="m-0 py-1 calender-time"><i
                                            class="fa fa-clock-o"></i> <?= date('F d Y', strtotime($event['date'])) . " " . date('H:i A', strtotime($event['time'])) ?>
                                </p>
                                <hr>
                                <?php
                            }
            ...
            <div class="col-12 col-md-8 col-lg-5">
                <div class="wrapper3">
                    ...
                    <p class="py-4">Trainings are endless and ongoing. There's a training for everything. Want to
                        learn about a product? There's a training for that. Need to learn about our system? There's a
                        training for that. Looking to improve your leadership skills? There's a training for that. You
                        will not fail here for lack of resources. </p>
                </div>
                ...
                <div class="wrapper3 py-3">
                    ...
                    <p class="py-2">These type of events, wether on Zoom or in person are designed to help you market
                        our products, services and opportunity. These are great resources to leverage a group of
                        people who want to learn more about who we are and what we do. </p>
                </div>
                <div class="wrapper3 py-3">
                    <h5 class="fw-bold">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p class="py-2">Learn the ins and outs of the products and services we provide. Every provider and
