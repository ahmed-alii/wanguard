                        ...
                        <div class="card card-wrapper">
                            <div class="card-body card-content text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     x="0px" y="0px" height="60px" width="60px" viewBox="0 0 24 24" xml:space="preserve"
                        ...
                        <div class="card card-wrapper">
                            <div class="card-body card-content text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     ...
                                     class="brz-icon-svg align-[initial]" height="60px" width="60px" data-type="glyph"
                        ...
                        <div class="card card-wrapper">
                            <div class="card-body card-content text-center">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                     ...
                                     x="0px" y="0px" viewBox="0 0 24 24" xml:space="preserve" height="60px" width="60px"
                        ...
                        <div class="card card-wrapper">
                            <div class="card-body card-content text-center">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                     ...
                                     viewBox="0 0 24 24" xml:space="preserve" class="brz-icon-svg align-[initial]"
                                     data-type="glyph"
        ...
        <div class="row px-5">
            ...
            <div class="col-12 col-md-8 col-lg-5">
                <div class="wrapper3">
                    ...
                    <p class="py-4">Trainings are endless and ongoing. There's a training for everything. Want to learn
                        about a
                        product?
                        There's a training for that. Need to learn about our system? There's a training for that.
                        Looking to
                        improve your leadership skills? There's a training for that. You will not fail here for lack of
                        resources. </p>
                </div>
                <div class="wrapper3 py-3">
                    ...
                    <p class="py-2">Weekly trainings available covering the A's to Z's of our business and system. </p>
                </div>
                <div class="wrapper3 py-3">
                    <h5 class="fw-bold">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <p class="py-2">These type of events, wether on Zoom or in person are designed to help you market
                        our products, services and opportunity. These are great resources to leverage a group of people
