                        ...
                        <table id="dashboard_inputs" class="table table-striped" style="width:100%">
                            ...
                            foreach ($Dashboard_Table_Data_Inputs as $Dashboard_Table_Data_Input) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i class="fa fa-edit p-2 btn btn-primary" title="Edit Dashboard Inputs"
                                           onclick="EditDashboardInputs(`<?= $Dashboard_Table_Data_Input['id'] ?>`,`<?= $Dashboard_Table_Data_Input['f_name'] ?>`,`<?= $Dashboard_Table_Data_Input['l_name'] ?>`,`<?= $Dashboard_Table_Data_Input['agency_team'] ?>`)"></i>
                                        <i class="fa fa-trash p-2 btn btn-danger" title="Delete team member"
                                           onclick="deleteDashboardInputs(`<?= $Dashboard_Table_Data_Input['id'] ?>`)"></i>
                                    </td>
                                </tr>
                                <?php
                            }
...
<div class="modal fade" id="edit_dashboard_inputs_modal" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
